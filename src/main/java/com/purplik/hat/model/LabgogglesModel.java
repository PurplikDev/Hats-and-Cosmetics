...
public class LabgogglesModel extends HumanoidModel<LivingEntity> {

    public LabgogglesModel(ModelPart modelPart) {
        super(modelPart);
    }
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition goggles = partDefinition.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, 24.0F, 0.0F));
