...
public class ShadesModel extends HumanoidModel<LivingEntity> {

    public ShadesModel(ModelPart modelPart) {
        super(modelPart);
    }
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition hat = partDefinition.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, -5.0F, -4.5F, 9.0F, 3.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-4.5F, -5.0F, -4.5F, 0.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(4.5F, -5.0F, -4.5F, 0.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
