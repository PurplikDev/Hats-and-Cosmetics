...
import com.purplik.hat.model.GogglesOfThaumaturgyModel;
...
public class GogglesOfThaumaturgyRenderer<L extends LivingEntity> implements ICurioRenderer {

    private static final ResourceLocation GOGGLES_OF_THAUMATURGY_TEXTURE = new ResourceLocation(Hat.MOD_ID,
            "textures/cosmetics/goggles_of_thaumaturgy.png");

    private final GogglesOfThaumaturgyModel model;

    public GogglesOfThaumaturgyRenderer() {
        this.model = new GogglesOfThaumaturgyModel(Minecraft.getInstance().getEntityModels().bakeLayer(CosmeticLayerDefinitions.GOGGLES_OF_THAUMATURGY));
    }
