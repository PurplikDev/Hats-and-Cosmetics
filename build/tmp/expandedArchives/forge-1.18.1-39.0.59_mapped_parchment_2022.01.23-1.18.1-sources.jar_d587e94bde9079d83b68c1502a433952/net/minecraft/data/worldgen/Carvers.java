...
public class Carvers {
   ...
   private static <WC extends CarverConfiguration> ConfiguredWorldCarver<WC> register(String pId, ConfiguredWorldCarver<WC> pCarver) {
      return BuiltinRegistries.register(BuiltinRegistries.CONFIGURED_CARVER, pId, pCarver);
   }
}