...
public class ChunkMap extends ChunkStorage implements ChunkHolder.PlayerProvider {
   ...
   private void scheduleUnload(long pChunkPos, ChunkHolder pChunkHolder) {
      ...
      completablefuture.thenAcceptAsync((p_198809_) -> {
         ...
         if (completablefuture1 != completablefuture) {
            ...
            if (this.pendingUnloads.remove(pChunkPos, pChunkHolder) && p_198809_ != null) {
               ...
               this.save(p_198809_);
               if (this.entitiesInLevel.remove(pChunkPos) && p_198809_ instanceof LevelChunk) {
         ...
         if (p_198804_ != null) {
            LOGGER.error("Failed to save chunk {}", pChunkHolder.getPos(), p_198804_);
         }
   ...
   private CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> scheduleChunkGeneration(ChunkHolder pChunkHolder, ChunkStatus pChunkStatus) {
      ...
      CompletableFuture<Either<List<ChunkAccess>, ChunkHolder.ChunkLoadingFailure>> completablefuture = this.getChunkRangeFuture(chunkpos, pChunkStatus.getRange(), (p_198865_) -> {
         return this.getDependencyStatus(pChunkStatus, p_198865_);
      });
      this.level.getProfiler().incrementCounter(() -> {
         return "chunkGenerate " + pChunkStatus.getName();
      });
      Executor executor = (p_198885_) -> {
         this.worldgenMailbox.tell(ChunkTaskPriorityQueueSorter.message(pChunkHolder, p_198885_));
      };
      return completablefuture.thenComposeAsync((p_199354_) -> {
         return p_199354_.map((p_199360_) -> {
            try {
               CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> completablefuture1 = pChunkStatus.generate(executor, this.level, this.generator, this.structureManager, this.lightEngine, (p_198855_) -> {
