...
public abstract class Registry<T> implements Keyable, IdMap<T> {
   ...
   @Deprecated public static final Registry<MobEffect> MOB_EFFECT = forge(MOB_EFFECT_REGISTRY, () -> {
   ...
   @Deprecated public static final Registry<BlockEntityType<?>> BLOCK_ENTITY_TYPE = forge(BLOCK_ENTITY_TYPE_REGISTRY, () -> {
      return BlockEntityType.FURNACE;
   });
   @Deprecated public static final DefaultedRegistry<Motive> MOTIVE = forge(MOTIVE_REGISTRY, "kebab", () -> {
      return Motive.KEBAB;
   });
   ...
   @Deprecated public static final Registry<MenuType<?>> MENU = forge(MENU_REGISTRY, () -> {
      return MenuType.ANVIL;
   });
   public static final Registry<RecipeType<?>> RECIPE_TYPE = registerSimple(RECIPE_TYPE_REGISTRY, () -> {
      return RecipeType.CRAFTING;
   });
   @Deprecated public static final Registry<RecipeSerializer<?>> RECIPE_SERIALIZER = forge(RECIPE_SERIALIZER_REGISTRY, () -> {
   ...
   @Deprecated public static final DefaultedRegistry<PoiType> POINT_OF_INTEREST_TYPE = forge(POINT_OF_INTEREST_TYPE_REGISTRY, "unemployed", () -> {
   ...
   @Deprecated public static final Registry<StructureFeature<?>> STRUCTURE_FEATURE = forge(STRUCTURE_FEATURE_REGISTRY, () -> {
   ...
   public static <T extends WritableRegistry<?>> void checkRegistry(WritableRegistry<T> pMetaRegistry) {
      pMetaRegistry.forEach((p_194585_) -> {
         if (p_194585_.keySet().isEmpty()) {
            Util.logAndPauseIfInIde("Registry '" + pMetaRegistry.getKey(p_194585_) + "' was empty after loading");
         }
