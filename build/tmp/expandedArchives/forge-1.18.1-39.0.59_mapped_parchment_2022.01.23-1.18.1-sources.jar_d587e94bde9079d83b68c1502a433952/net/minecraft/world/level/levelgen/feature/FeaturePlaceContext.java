...
public class FeaturePlaceContext<FC extends FeatureConfiguration> {
   ...
   public FeaturePlaceContext(Optional<ConfiguredFeature<?, ?>> pTopFeature, WorldGenLevel pLevel, ChunkGenerator pChunkGenerator, Random pRandom, BlockPos pOrigin, FC pConfig) {
