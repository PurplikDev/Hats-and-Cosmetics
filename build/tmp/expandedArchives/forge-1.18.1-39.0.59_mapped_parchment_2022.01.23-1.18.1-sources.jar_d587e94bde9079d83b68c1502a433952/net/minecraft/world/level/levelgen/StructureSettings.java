...
public class StructureSettings {
   ...
   public StructureSettings(boolean pWithStronghold) {
      this(Maps.newHashMap(DEFAULTS), pWithStronghold ? DEFAULT_STRONGHOLD : null);
   }
   ...
   @Nullable
   public StructureFeatureConfiguration getConfig(StructureFeature<?> pStructure) {
