...
public class PillagerOutpostFeature extends JigsawFeature {
   ...
   private static boolean isNearVillage(ChunkGenerator pChunkGenerator, long pSeed, ChunkPos pChunkPos) {
      ...
      if (structurefeatureconfiguration == null) {
         ...
         for(int k = i - 10; k <= i + 10; ++k) {
            for(int l = j - 10; l <= j + 10; ++l) {
               ChunkPos chunkpos = StructureFeature.VILLAGE.getPotentialFeatureChunk(structurefeatureconfiguration, pSeed, k, l);
