...
public class JigsawPlacement {
   ...
   public static void addPieces(RegistryAccess pRegistryAccess, PoolElementStructurePiece pPiece, int pMaxDepth, JigsawPlacement.PieceFactory pFactory, ChunkGenerator pChunkGenerator, StructureManager pStructureManager, List<? super PoolElementStructurePiece> pPieces, Random pRandom, LevelHeightAccessor pLevel) {
      Registry<StructureTemplatePool> registry = pRegistryAccess.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY);
      JigsawPlacement.Placer jigsawplacement$placer = new JigsawPlacement.Placer(registry, pMaxDepth, pFactory, pChunkGenerator, pStructureManager, pPieces, pRandom);
      jigsawplacement$placer.placing.addLast(new JigsawPlacement.PieceState(pPiece, new MutableObject<>(Shapes.INFINITY), 0));
   ...
   static final class Placer {
      ...
      Placer(Registry<StructureTemplatePool> pPools, int pMaxDepth, JigsawPlacement.PieceFactory pFactory, ChunkGenerator pChunkGenerator, StructureManager pStructureManager, List<? super PoolElementStructurePiece> pPieces, Random pRandom) {
         this.pools = pPools;
