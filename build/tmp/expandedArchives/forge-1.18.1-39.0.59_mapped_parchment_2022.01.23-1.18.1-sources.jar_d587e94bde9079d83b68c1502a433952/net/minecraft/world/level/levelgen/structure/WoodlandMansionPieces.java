...
public class WoodlandMansionPieces {
   ...
   public static class WoodlandMansionPiece extends TemplateStructurePiece {
      ...
      public WoodlandMansionPiece(StructureManager pStructureManager, CompoundTag pTag) {
         super(StructurePieceType.WOODLAND_MANSION_PIECE, pTag, pStructureManager, (p_163709_) -> {
