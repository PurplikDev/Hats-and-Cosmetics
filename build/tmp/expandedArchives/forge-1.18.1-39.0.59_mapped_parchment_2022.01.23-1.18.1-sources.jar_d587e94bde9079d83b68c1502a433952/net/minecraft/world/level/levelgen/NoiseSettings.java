...
public record NoiseSettings(int minY, int height, NoiseSamplingSettings noiseSamplingSettings, NoiseSlider topSlideSettings, NoiseSlider bottomSlideSettings, int noiseSizeHorizontal, int noiseSizeVertical, boolean islandNoiseOverride, boolean isAmplified, boolean largeBiomes, TerrainShaper terrainShaper) {
   ...
   public static NoiseSettings create(int pMinY, int pHeight, NoiseSamplingSettings pNoiseSamplingSettings, NoiseSlider pTopSlideSettings, NoiseSlider pBottomSlideSettings, int pNoiseSizeHorizontal, int pNoiseSizeVertical, boolean pIslandNoiseOverride, boolean pIsAmplified, boolean pLargeBiomes, TerrainShaper pTerrarianShaper) {
      NoiseSettings noisesettings = new NoiseSettings(pMinY, pHeight, pNoiseSamplingSettings, pTopSlideSettings, pBottomSlideSettings, pNoiseSizeHorizontal, pNoiseSizeVertical, pIslandNoiseOverride, pIsAmplified, pLargeBiomes, pTerrarianShaper);
