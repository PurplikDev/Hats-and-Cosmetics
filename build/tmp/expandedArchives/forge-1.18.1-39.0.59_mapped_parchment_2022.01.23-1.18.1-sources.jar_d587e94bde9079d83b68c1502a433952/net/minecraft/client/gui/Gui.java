...
public class Gui extends GuiComponent {
   ...
   protected void renderCrosshair(PoseStack pPoseStack) {
      ...
      if (!collection.isEmpty()) {
         ...
         for(MobEffectInstance mobeffectinstance : Ordering.natural().reverse().sortedCopy(collection)) {
            ...
            if (mobeffectinstance.showIcon()) {
               ...
               renderer.renderHUDEffect(mobeffectinstance,this, pPoseStack, i, j, this.getBlitOffset(), f);
            }
         }
   ...
   protected void displayScoreboardSidebar(PoseStack pPoseStack, Objective pObjective) {
   ...
   public void handleChat(ChatType pChatType, Component pComponent, UUID pSenderId) {
      if (!this.minecraft.isBlocked(pSenderId)) {
         if (!this.minecraft.options.hideMatchedNames || !this.minecraft.isBlocked(this.guessChatUUID(pComponent))) {
