...
public abstract class WorldPreset {
   ...
   public WorldGenSettings create(RegistryAccess.RegistryHolder pRegistryHolder, long pSeed, boolean pGenerateFeatures, boolean pGenerateBonusChest) {
      return new WorldGenSettings(pSeed, pGenerateFeatures, pGenerateBonusChest, WorldGenSettings.withOverworld(pRegistryHolder.registryOrThrow(Registry.DIMENSION_TYPE_REGISTRY), DimensionType.defaultDimensions(pRegistryHolder, pSeed), this.generator(pRegistryHolder, pSeed)));
   }
