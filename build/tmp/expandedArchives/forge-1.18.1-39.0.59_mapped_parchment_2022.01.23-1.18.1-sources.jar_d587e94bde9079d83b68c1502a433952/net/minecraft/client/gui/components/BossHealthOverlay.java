      ...
      if (!this.events.isEmpty()) {
         ...
         for(LerpingBossEvent lerpingbossevent : this.events.values()) {
            ...
            net.minecraftforge.client.event.RenderGameOverlayEvent.BossInfo event =
               net.minecraftforge.client.ForgeHooksClient.renderBossEventPre(pPoseStack, this.minecraft.getWindow(), lerpingbossevent, k, j, 10 + this.minecraft.font.lineHeight);
            if (!event.isCanceled()) {
            ...
            net.minecraftforge.client.ForgeHooksClient.renderBossEventPost(pPoseStack, this.minecraft.getWindow());
