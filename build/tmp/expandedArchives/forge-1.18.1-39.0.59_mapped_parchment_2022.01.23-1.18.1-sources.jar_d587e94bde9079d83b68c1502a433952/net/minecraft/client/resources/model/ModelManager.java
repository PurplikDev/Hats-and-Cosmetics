...
public class ModelManager extends SimplePreparableReloadListener<ModelBakery> implements AutoCloseable {
   ...
   protected ModelBakery prepare(ResourceManager pResourceManager, ProfilerFiller pProfiler) {
      pProfiler.startTick();
      net.minecraftforge.client.model.ForgeModelBakery modelbakery = new net.minecraftforge.client.model.ForgeModelBakery(pResourceManager, this.blockColors, pProfiler, this.maxMipmapLevels);
      pProfiler.endTick();
      return modelbakery;
   }
   ...
   protected void apply(ModelBakery pObject, ResourceManager pResourceManager, ProfilerFiller pProfiler) {
      ...
      net.minecraftforge.client.ForgeHooksClient.onModelBake(this, this.bakedRegistry, (net.minecraftforge.client.model.ForgeModelBakery) pObject);
