...
public class MouseHandler {
   ...
   private void onPress(long pWindowPointer, int pButton, int pAction, int pModifiers) {
      if (pWindowPointer == this.minecraft.getWindow().getWindow()) {
         ...
         if (net.minecraftforge.client.ForgeHooksClient.onRawMouseClicked(pButton, pAction, pModifiers)) return;
            ...
            if (this.minecraft.screen == null) {
               ...
               if (flag) {
                  ...
                  Screen.wrapScreenError(() -> {
                     aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onScreenMouseClickedPre(this.minecraft.screen, d0, d1, i);
                     if (!aboolean[0]) {
                        aboolean[0] = this.minecraft.screen.mouseClicked(d0, d1, i);
                        aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onScreenMouseClickedPost(this.minecraft.screen, d0, d1, i, aboolean[0]);
                     }
                  }, "mouseClicked event handler", screen.getClass().getCanonicalName());
               } else {
                  Screen.wrapScreenError(() -> {
                     aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onScreenMouseReleasedPre(this.minecraft.screen, d0, d1, i);
                     if (!aboolean[0]) {
                        aboolean[0] = this.minecraft.screen.mouseReleased(d0, d1, i);
                        aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onScreenMouseReleasedPost(this.minecraft.screen, d0, d1, i, aboolean[0]);
                     }
         ...
         net.minecraftforge.client.ForgeHooksClient.fireMouseInput(pButton, pAction, pModifiers);
      }
   }
