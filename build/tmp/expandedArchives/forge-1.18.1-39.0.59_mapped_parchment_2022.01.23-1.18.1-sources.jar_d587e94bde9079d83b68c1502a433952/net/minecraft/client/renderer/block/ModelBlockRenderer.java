...
public class ModelBlockRenderer {
   ...
   public boolean tesselateBlock(BlockAndTintGetter pLevel, BakedModel pModel, BlockState pState, BlockPos pPos, PoseStack pPoseStack, VertexConsumer pConsumer, boolean pCheckSides, Random pRandom, long pSeed, int pPackedOverlay) {
       return tesselateBlock(pLevel, pModel, pState, pPos, pPoseStack, pConsumer, pCheckSides, pRandom, pSeed, pPackedOverlay, net.minecraftforge.client.model.data.EmptyModelData.INSTANCE);
   }
   public boolean tesselateBlock(BlockAndTintGetter pLevel, BakedModel pModel, BlockState pState, BlockPos pPos, PoseStack pPoseStack, VertexConsumer pConsumer, boolean pCheckSides, Random pRandom, long pSeed, int pPackedOverlay, net.minecraftforge.client.model.data.IModelData modelData) {
      boolean flag = Minecraft.useAmbientOcclusion() && pState.getLightEmission(pLevel, pPos) == 0 && pModel.useAmbientOcclusion();
      Vec3 vec3 = pState.getOffset(pLevel, pPos);
      pPoseStack.translate(vec3.x, vec3.y, vec3.z);
      modelData = pModel.getModelData(pLevel, pPos, pState, modelData);

      try {
         return flag ? this.tesselateWithAO(pLevel, pModel, pState, pPos, pPoseStack, pConsumer, pCheckSides, pRandom, pSeed, pPackedOverlay, modelData) : this.tesselateWithoutAO(pLevel, pModel, pState, pPos, pPoseStack, pConsumer, pCheckSides, pRandom, pSeed, pPackedOverlay, modelData);
   ...
   public boolean tesselateWithAO(BlockAndTintGetter pLevel, BakedModel pModel, BlockState pState, BlockPos pPos, PoseStack pPoseStack, VertexConsumer pConsumer, boolean pCheckSides, Random pRandom, long pSeed, int pPackedOverlay) {
       return tesselateWithAO(pLevel, pModel, pState, pPos, pPoseStack, pConsumer, pCheckSides, pRandom, pSeed, pPackedOverlay, net.minecraftforge.client.model.data.EmptyModelData.INSTANCE);
   }
   public boolean tesselateWithAO(BlockAndTintGetter pLevel, BakedModel pModel, BlockState pState, BlockPos pPos, PoseStack pPoseStack, VertexConsumer pConsumer, boolean pCheckSides, Random pRandom, long pSeed, int pPackedOverlay, net.minecraftforge.client.model.data.IModelData modelData) {
      boolean flag = false;
   ...
   public boolean tesselateWithoutAO(BlockAndTintGetter pLevel, BakedModel pModel, BlockState pState, BlockPos pPos, PoseStack pPoseStack, VertexConsumer pConsumer, boolean pCheckSides, Random pRandom, long pSeed, int pPackedOverlay) {
       return tesselateWithoutAO(pLevel, pModel, pState, pPos, pPoseStack, pConsumer, pCheckSides, pRandom, pSeed, pPackedOverlay, net.minecraftforge.client.model.data.EmptyModelData.INSTANCE);
   }
   ...
   public void renderModel(PoseStack.Pose pPose, VertexConsumer pConsumer, @Nullable BlockState pState, BakedModel pModel, float pRed, float pGreen, float pBlue, int pPackedLight, int pPackedOverlay) {
      renderModel(pPose, pConsumer, pState, pModel, pRed, pGreen, pBlue, pPackedLight, pPackedOverlay, net.minecraftforge.client.model.data.EmptyModelData.INSTANCE);
   }
   public void renderModel(PoseStack.Pose pPose, VertexConsumer pConsumer, @Nullable BlockState pState, BakedModel pModel, float pRed, float pGreen, float pBlue, int pPackedLight, int pPackedOverlay, net.minecraftforge.client.model.data.IModelData modelData) {
      ...
      random.setSeed(42L);
      renderQuadList(pPose, pConsumer, pRed, pGreen, pBlue, pModel.getQuads(pState, (Direction)null, random, modelData), pPackedLight, pPackedOverlay);
   }
