         ...
         if (screen != null) {
            ...
            Screen.wrapScreenError(() -> {
               if (pAction != 1 && (pAction != 2 || !this.sendRepeatsToGui)) {
                  if (pAction == 0) {
                     aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onScreenKeyReleasedPre(this.minecraft.screen, pKey, pScanCode, pModifiers);
                     if (!aboolean[0]) aboolean[0] = screen.keyReleased(pKey, pScanCode, pModifiers);
                     if (!aboolean[0]) aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onScreenKeyReleasedPost(this.minecraft.screen, pKey, pScanCode, pModifiers);
                  }
               } else {
                  screen.afterKeyboardAction();
                  aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onScreenKeyPressedPre(this.minecraft.screen, pKey, pScanCode, pModifiers);
                  if (!aboolean[0]) aboolean[0] = screen.keyPressed(pKey, pScanCode, pModifiers);
                  if (!aboolean[0]) aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onScreenKeyPressedPost(this.minecraft.screen, pKey, pScanCode, pModifiers);
               }
      ...
      if (pWindowPointer == this.minecraft.getWindow().getWindow()) {
         ...
         if (guieventlistener != null && this.minecraft.getOverlay() == null) {
            if (Character.charCount(pCodePoint) == 1) {
               Screen.wrapScreenError(() -> {
                  if (net.minecraftforge.client.ForgeHooksClient.onScreenCharTypedPre(this.minecraft.screen, (char)pCodePoint, pModifiers)) return;
                  if (guieventlistener.charTyped((char)pCodePoint, pModifiers)) return;
                  net.minecraftforge.client.ForgeHooksClient.onScreenCharTypedPost(this.minecraft.screen, (char)pCodePoint, pModifiers);
               }, "charTyped event handler", guieventlistener.getClass().getCanonicalName());
            } else {
               for(char c0 : Character.toChars(pCodePoint)) {
                  Screen.wrapScreenError(() -> {
                     if (net.minecraftforge.client.ForgeHooksClient.onScreenCharTypedPre(this.minecraft.screen, c0, pModifiers)) return;
                     if (guieventlistener.charTyped(c0, pModifiers)) return;
                     net.minecraftforge.client.ForgeHooksClient.onScreenCharTypedPost(this.minecraft.screen, c0, pModifiers);
                  }, "charTyped event handler", guieventlistener.getClass().getCanonicalName());
               }
            }
