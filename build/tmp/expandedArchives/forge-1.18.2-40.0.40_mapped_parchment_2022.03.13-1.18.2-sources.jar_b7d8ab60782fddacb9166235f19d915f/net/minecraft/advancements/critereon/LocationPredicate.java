...
public class LocationPredicate {
   ...
   public static LocationPredicate atYLocation(MinMaxBounds.Doubles pYRange) {
      return new LocationPredicate(MinMaxBounds.Doubles.ANY, pYRange, MinMaxBounds.Doubles.ANY, (ResourceKey<Biome>)null, (ResourceKey<ConfiguredStructureFeature<?, ?>>)null, (ResourceKey<Level>)null, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
   }
