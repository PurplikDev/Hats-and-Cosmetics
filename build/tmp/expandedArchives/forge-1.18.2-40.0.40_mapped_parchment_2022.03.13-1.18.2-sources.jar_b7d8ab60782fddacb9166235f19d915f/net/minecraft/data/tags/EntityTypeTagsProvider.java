...
public class EntityTypeTagsProvider extends TagsProvider<EntityType<?>> {
   ...
   public EntityTypeTagsProvider(DataGenerator pGenerator, String modId, @org.jetbrains.annotations.Nullable net.minecraftforge.common.data.ExistingFileHelper existingFileHelper) {
