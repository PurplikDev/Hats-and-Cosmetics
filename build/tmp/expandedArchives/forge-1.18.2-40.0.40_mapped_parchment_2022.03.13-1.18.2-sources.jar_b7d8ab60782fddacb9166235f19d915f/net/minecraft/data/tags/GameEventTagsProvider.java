...
public class GameEventTagsProvider extends TagsProvider<GameEvent> {
   ...
   public GameEventTagsProvider(DataGenerator pGenerator, String modId, @org.jetbrains.annotations.Nullable net.minecraftforge.common.data.ExistingFileHelper existingFileHelper) {
