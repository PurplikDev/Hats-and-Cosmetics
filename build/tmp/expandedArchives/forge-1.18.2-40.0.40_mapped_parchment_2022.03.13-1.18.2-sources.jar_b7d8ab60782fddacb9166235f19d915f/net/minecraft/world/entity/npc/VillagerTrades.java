...
public class VillagerTrades {
   ...
   static class TreasureMapForEmeralds implements VillagerTrades.ItemListing {
      ...
      public TreasureMapForEmeralds(int pEmeraldCost, TagKey<ConfiguredStructureFeature<?, ?>> pDestination, String pDisplayName, MapDecoration.Type pDestinationType, int pMaxUses, int pVillagerXp) {
         this.emeraldCost = pEmeraldCost;
