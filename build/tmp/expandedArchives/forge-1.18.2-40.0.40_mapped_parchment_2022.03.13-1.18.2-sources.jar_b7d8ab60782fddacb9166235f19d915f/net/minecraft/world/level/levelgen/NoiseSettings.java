...
public record NoiseSettings(int minY, int height, NoiseSamplingSettings noiseSamplingSettings, NoiseSlider topSlideSettings, NoiseSlider bottomSlideSettings, int noiseSizeHorizontal, int noiseSizeVertical, TerrainShaper terrainShaper) {
   ...
   public static NoiseSettings create(int pMinY, int pHeight, NoiseSamplingSettings pNoiseSamplingSettings, NoiseSlider pTopSlideSettings, NoiseSlider pBottomSlideSettings, int pNoiseSizeHorizontal, int pNoiseSizeVertical, TerrainShaper pTerrainShaper) {
      NoiseSettings noisesettings = new NoiseSettings(pMinY, pHeight, pNoiseSamplingSettings, pTopSlideSettings, pBottomSlideSettings, pNoiseSizeHorizontal, pNoiseSizeVertical, pTerrainShaper);
