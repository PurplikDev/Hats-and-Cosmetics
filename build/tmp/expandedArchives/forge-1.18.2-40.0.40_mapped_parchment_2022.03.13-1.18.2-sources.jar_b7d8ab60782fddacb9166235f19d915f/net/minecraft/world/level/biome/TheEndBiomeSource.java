...
public class TheEndBiomeSource extends BiomeSource {
   ...
   private TheEndBiomeSource(long pSeed, Holder<Biome> pEnd, Holder<Biome> pHighlands, Holder<Biome> pMidlands, Holder<Biome> pIslands, Holder<Biome> pBarrens) {
      ...
      WorldgenRandom worldgenrandom = new WorldgenRandom(new LegacyRandomSource(pSeed));
