...
public class CanyonCarverConfiguration extends CarverConfiguration {
   ...
   public CanyonCarverConfiguration(float pProbability, HeightProvider pY, FloatProvider pYScale, VerticalAnchor pLavaLevel, CarverDebugSettings pDebugSettings, FloatProvider pVerticalRotation, CanyonCarverConfiguration.CanyonShapeConfiguration pShape) {
