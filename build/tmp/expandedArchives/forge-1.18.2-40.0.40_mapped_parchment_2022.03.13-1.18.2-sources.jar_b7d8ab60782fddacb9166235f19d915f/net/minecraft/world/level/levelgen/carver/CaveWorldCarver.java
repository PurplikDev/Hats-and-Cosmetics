...
public class CaveWorldCarver extends WorldCarver<CaveCarverConfiguration> {
    ...
    */
   public boolean carve(CarvingContext pContext, CaveCarverConfiguration pConfig, ChunkAccess pChunk, Function<BlockPos, Holder<Biome>> pBiomeAccessor, Random pRandom, Aquifer pAquifer, ChunkPos pChunkPos, CarvingMask pCarvingMask) {
