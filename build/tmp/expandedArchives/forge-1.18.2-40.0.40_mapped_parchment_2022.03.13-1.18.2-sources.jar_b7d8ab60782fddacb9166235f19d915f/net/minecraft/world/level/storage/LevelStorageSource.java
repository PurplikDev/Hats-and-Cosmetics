...
public class LevelStorageSource {
   ...
   static BiFunction<File, DataFixer, PrimaryLevelData> getLevelData(DynamicOps<Tag> pOps, DataPackConfig pDatapackConfig, Lifecycle pLifecycle) {
      return (p_211745_, p_211746_) -> {
         try {
            ...
            int i = compoundtag1.contains("DataVersion", 99) ? compoundtag1.getInt("DataVersion") : -1;
            Dynamic<Tag> dynamic = p_211746_.update(DataFixTypes.LEVEL.getType(), new Dynamic<>(pOps, compoundtag1), i, SharedConstants.getCurrentVersion().getWorldVersion());
   ...
   public class LevelStorageAccess implements AutoCloseable {
      ...
      public WorldData getDataTag(DynamicOps<Tag> pOps, DataPackConfig pDataPackConfig, Lifecycle pLifecycle) {
         this.checkLock();
         return LevelStorageSource.this.readLevelData(this.levelPath.toFile(), LevelStorageSource.getLevelData(pOps, pDataPackConfig, pLifecycle));
      }
