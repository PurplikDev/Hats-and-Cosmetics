...
public class ClientboundRespawnPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundRespawnPacket(Holder<DimensionType> pDimensionType, ResourceKey<Level> pDimension, long pSeed, GameType pPlayerGameType, @Nullable GameType pPreviousPlayerGameType, boolean pIsDebug, boolean pIsFlat, boolean pKeepAllPlayerData) {
