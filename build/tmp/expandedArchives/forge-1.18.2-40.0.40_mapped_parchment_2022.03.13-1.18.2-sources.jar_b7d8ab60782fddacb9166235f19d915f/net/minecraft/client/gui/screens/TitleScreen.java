...
public class TitleScreen extends Screen {
   ...
   private void createNormalMenuOptions(int pY, int pRowHeight) {
      this.addRenderableWidget(new Button(this.width / 2 - 100, pY, 200, 20, new TranslatableComponent("menu.singleplayer"), (p_96776_) -> {
      ...
      (this.addRenderableWidget(new Button(this.width / 2 - 100, pY + pRowHeight * 1, 200, 20, new TranslatableComponent("menu.multiplayer"), (p_210872_) -> {
   ...
   private void createDemoMenuOptions(int pY, int pRowHeight) {
      ...
      this.addRenderableWidget(new Button(this.width / 2 - 100, pY, 200, 20, new TranslatableComponent("menu.playdemo"), (p_211786_) -> {
         if (flag) {
      ...
      this.resetDemoButton = this.addRenderableWidget(new Button(this.width / 2 - 100, pY + pRowHeight * 1, 200, 20, new TranslatableComponent("menu.resetdemo"), (p_211783_) -> {
      ...
      if ((l & -67108864) != 0) {
         ...
         if (this.minceraftEasterEgg) {
            this.blitOutlineBlack(j, 30, (p_210862_, p_210863_) -> {
               this.blit(pPoseStack, p_210862_ + 0, p_210863_, 0, 0, 99, 44);
               this.blit(pPoseStack, p_210862_ + 99, p_210863_, 129, 0, 27, 44);
               this.blit(pPoseStack, p_210862_ + 99 + 26, p_210863_, 126, 0, 3, 44);
               this.blit(pPoseStack, p_210862_ + 99 + 26 + 3, p_210863_, 99, 0, 26, 44);
               this.blit(pPoseStack, p_210862_ + 155, p_210863_, 0, 45, 155, 44);
            });
         } else {
            this.blitOutlineBlack(j, 30, (p_211778_, p_211779_) -> {
               this.blit(pPoseStack, p_211778_ + 0, p_211779_, 0, 0, 155, 44);
               this.blit(pPoseStack, p_211778_ + 155, p_211779_, 0, 45, 155, 44);
            });
         }
         ...
         if (this.warning32Bit != null) {
            this.warning32Bit.label.renderBackgroundCentered(pPoseStack, this.warning32Bit.x, this.warning32Bit.y, 9, 2, 1428160512);
            this.warning32Bit.label.renderCentered(pPoseStack, this.warning32Bit.x, this.warning32Bit.y, 9, 16777215 | l);
         }
