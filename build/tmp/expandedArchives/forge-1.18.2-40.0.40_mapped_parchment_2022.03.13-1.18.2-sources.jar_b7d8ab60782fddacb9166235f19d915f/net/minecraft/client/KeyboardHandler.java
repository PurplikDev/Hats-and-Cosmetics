...
public class KeyboardHandler {
   ...
   private void debugComponent(ChatFormatting pFormatting, Component pMessage) {
      this.minecraft.gui.getChat().addMessage((new TextComponent("")).append((new TranslatableComponent("debug.prefix")).withStyle(new ChatFormatting[]{pFormatting, ChatFormatting.BOLD})).append(" ").append(pMessage));
   }
