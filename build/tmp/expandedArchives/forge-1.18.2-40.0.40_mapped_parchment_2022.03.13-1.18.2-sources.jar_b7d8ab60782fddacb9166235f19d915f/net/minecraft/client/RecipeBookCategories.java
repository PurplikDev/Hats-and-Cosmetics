...
public enum RecipeBookCategories implements net.minecraftforge.common.IExtensibleEnum {
   ...
   public static List<RecipeBookCategories> getCategories(RecipeBookType pRecipeBookType) {
      ...
      default:
         if (net.minecraftforge.client.RecipeBookRegistry.TYPE_TO_CATEGORIES_VIEW.containsKey(pRecipeBookType))
            return net.minecraftforge.client.RecipeBookRegistry.TYPE_TO_CATEGORIES_VIEW.get(pRecipeBookType);
