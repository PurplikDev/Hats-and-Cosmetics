...
public class BlockRenderDispatcher implements ResourceManagerReloadListener {
   ...
   public boolean renderLiquid(BlockPos pPos, BlockAndTintGetter pLevel, VertexConsumer pConsumer, BlockState pBlockState, FluidState pFluidState) {
      try {
         return this.liquidBlockRenderer.tesselate(pLevel, pPos, pConsumer, pBlockState, pFluidState);
      } catch (Throwable throwable) {
