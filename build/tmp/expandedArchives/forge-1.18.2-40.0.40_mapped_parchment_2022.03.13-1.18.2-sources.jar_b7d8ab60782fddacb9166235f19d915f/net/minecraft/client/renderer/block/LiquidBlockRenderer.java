...
public class LiquidBlockRenderer {
   ...
   public static boolean shouldRenderFace(BlockAndTintGetter pLevle, BlockPos pPos, FluidState pFluidState, BlockState pBlockState, Direction pSide, FluidState pNeighborFluid) {
      return !isFaceOccludedBySelf(pLevle, pPos, pBlockState, pSide) && !isNeighborSameFluid(pFluidState, pNeighborFluid);
   }

   public boolean tesselate(BlockAndTintGetter pLevel, BlockPos pPos, VertexConsumer pConsumer, BlockState pBlockState, FluidState pFluidState) {
