...
public class VanillaPackResources implements PackResources, ResourceProvider {
   ...
   public Resource getResource(final ResourceLocation pResourceLocation) throws IOException {
      return new Resource() {
         @Nullable
         ...
         public InputStream getInputStream() {
            try {
               this.inputStream = VanillaPackResources.this.getResource(PackType.CLIENT_RESOURCES, pResourceLocation);
            } catch (IOException ioexception) {
         ...
         public String getSourceName() {
            return pResourceLocation.toString();
         }
      };
   }
}
