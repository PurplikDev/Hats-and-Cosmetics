...
public class Mth {
   ...
   public static int randomBetweenInclusive(Random pRandom, int pMinInclusive, int pMaxInclusive) {
      return pRandom.nextInt(pMaxInclusive - pMinInclusive + 1) + pMinInclusive;
   }

   public static float randomBetween(Random pRandom, float pMinInclusive, float pMaxExclusive) {
    ...
    */
   public static float normal(Random pRandom, float pMean, float pDeviation) {
