...
public class ItemParser {
   ...
   public CompletableFuture<Suggestions> fillSuggestions(SuggestionsBuilder pBuilder, Registry<Item> pItemRegistry) {
      return this.suggestions.apply(pBuilder.createOffset(this.reader.getCursor()), pItemRegistry);
   }
}