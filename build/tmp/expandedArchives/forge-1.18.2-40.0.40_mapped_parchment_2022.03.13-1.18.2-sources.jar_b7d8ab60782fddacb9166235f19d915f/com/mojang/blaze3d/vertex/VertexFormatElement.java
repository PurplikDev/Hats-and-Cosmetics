...
public class VertexFormatElement {
   ...
   public void setupBufferState(int pOffset, long pVertexSize, int pElementIndex) {
      this.usage.setupBufferState(this.count, this.type.getGlType(), pElementIndex, pVertexSize, this.index, pOffset);
   }
   ...
   public static enum Usage {
      ...
      void setupBufferState(int pCount, int pGlType, int pVertexSize, long pOffset, int pIndex, int pStateIndex) {
         this.setupState.setupBufferState(pCount, pGlType, pVertexSize, pOffset, pIndex, pStateIndex);
      }
